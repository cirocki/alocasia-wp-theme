...
function alocasia_theme_scripts() {
	...
	wp_style_add_data( 'alocasia_theme-style', 'rtl', 'replace' );

	wp_enqueue_script( 'alocasia_theme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
